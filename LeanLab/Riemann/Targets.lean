...
def rhTargets : List ResearchTarget :=
  [ { id := "T1.r1.baez.duarte.qtwo.criterion"
    ...
    { id := "T2.audit.gaussian-prime-kernel-sign"
      ...
      status := .proven
      note := "Audit AUDIT-20260716-R5-GAUSSIAN-PRIME-KERNEL-SIGN-01 uses width (log 2)^2/16 and shifts 0, log 2. The exact arithmetic kernel has a negative (1,-1) quadratic direction and a positive diagonal direction. Implementation commit 01ea63517670a81b8c640de1135dec62d44436b9 passed public Lean Action CI run 29462677629, build job 87509304721. This eliminates termwise same-sign local-prime Gram assembly only; cancellation in the complete pole, archimedean, and prime form, G6/W1, G7/W2, and RH remain open." },
