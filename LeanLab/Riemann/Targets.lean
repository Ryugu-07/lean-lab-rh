...
def rhTargets : List ResearchTarget :=
  [ { id := "T1.r1.baez.duarte.qtwo.criterion"
    ...
    { id := "T2.weil.compact-laplace-xi-divisor-separator"
      ...
      status := .proven
      note := "Campaign CAMPAIGN-20260716-R5-COMPACT-LAPLACE-SEPARATOR-01 proves twofold integration-by-parts decay, complete xi-divisor summability, finite superlevel annihilation by a real-shift exponential polynomial, and geometric suppression by compact convolution powers. Equal-value multiplicity copies are protected. Implementation commit 6d12bad98b80c34217757df01943509965a64781 passed public Lean Action CI run 29461298466, build job 87505125618. This compiles one unconditional W1 reverse-separation subedge; the generic explicit formula, Weil positivity, G7/W2, and RH remain open." },
