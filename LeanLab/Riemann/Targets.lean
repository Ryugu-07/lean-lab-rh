...
def rhTargets : List ResearchTarget :=
  [ { id := "T1.r1.baez.duarte.qtwo.criterion"
    ...
    { id := "T2.audit.polson-ggc-imaginary-tail"
      ...
      status := .proven
      note := "Audit AUDIT-20260716-R5-POLSON-GGC-CONTINUATION-01 Lean-checks the exact complex-to-real specialization and the positive exponential tail. Implementation commit 0c174e82713c18be16ae9ea3afd5197b77ab4347 passed public Lean Action CI run 29455171888, build job 87486632024. It eliminates retention of the 2018 defining integral outside its convergence domain, but does not obstruct analytic continuation, reject the revised 2026 RH-equivalent Thorin framework, or imply RH or its negation." },
