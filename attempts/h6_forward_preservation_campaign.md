...
- `campaign_status`: exact implementation and immutable evidence verified by public CI; campaign
  publicly closed; persistent RH Goal remains active
...
- `public_evidence_backfill`: commit `b6e9dd7f6492f60574be68796f38818661422359`, Lean Action CI
  run `29527202922`, build job `87718477219`, passed in `1m57s`.
- `closure`: H6-H2c is publicly closed. Return to fresh value-ranked route selection without
  pausing the persistent RH Goal.
