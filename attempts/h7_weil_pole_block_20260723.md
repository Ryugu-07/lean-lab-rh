...
- `parent_public_ci`: run `29969901015`, build job `89089454873`, passed in `2m0s`.
- `selected_node`: `H7-WEIL-POLE-RANK-TWO-INSTANTIATION-01`.
- `preregistration`: `research/h7_weil_pole_block_prereg_20260723.md`.
- `global_goal`: active.
...
| --- | --- | --- | --- |
| 1 | `PARENT_PUBLIC_CLOSURE` | The H1 auxiliary final ledger passed public CI. Its local source algebra closes, while the Mellin/contour bridge remains open. | Return to cross-route value ranking rather than automatically continuing H1. |
...
- `hard_gap_before`: total Weil parity ordering, simple-even uniformity, ground-state/prolate
  comparison, and source transform convergence are open.
- `registered_delta`: instantiate only the actual source pole block and its parity signs.
