...
|---|---|---|---|
| 1 | `ROUTE_MAP` | Rebuilt the frontier after public closure of the symmetric Gaussian probe family. R1/M2 has recorded sparse-span and literature obstructions but is open under V4.1; R4's next edge is conjectural; R5/G6 still lacks a genuine test core, density, continuity, and regularization. | Audit a density-first continuation against smaller but compositional G6 edges. |
