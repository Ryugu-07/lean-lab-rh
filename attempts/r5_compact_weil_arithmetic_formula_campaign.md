...
|---|---|---|---|
| 1 | `INDEPENDENT_AUDIT -> ROUTE_SELECTION` | The compact zero-side campaign is publicly closed with preregistration, implementation, evidence, and closure CI. W1c1 now has one remaining compact arithmetic subedge; W2/G7 and open G3/M2 remain open. | Rotate from LITERATURE to DISCOVERY and test whether current Fourier, contour, and decay interfaces suffice for the complete compact arithmetic formula. |
