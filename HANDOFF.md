...
## RH current handoff (2026-07-15, R5 Weil explicit integrand locally verified)

- The persistent RH goal remains active. `CAMPAIGN-20260715-R5-WEIL-EXPLICIT-INTEGRAND-01`
  closes locally as `BRIDGE_REDUCED`: one source-level W1c subedge closes, while RH progress is
  unchanged.
...
- W1c1 test-function integration and contour cutoff, W1c2 regularization/covariance extension,
  W2 positivity, and RH remain open. Next: publish implementation, verify public CI, backfill
  evidence, close the campaign publicly, and return to fresh route selection.
