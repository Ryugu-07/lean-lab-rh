...
- Standalone compilation, Targets, the complete exact TargetCheck, seven selected standard-only
  ...
  `hard_gap_delta=0`, `route_infrastructure_delta=1`. Public implementation CI is pending; the
  finite endpoint is not extrapolated to the all-index RH-equivalent criterion.
