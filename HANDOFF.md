...
- The new proof angle pairs conjugate genus-one Weierstrass factors, constructs conjugation on the
  ...
  Exact preregistration is in `research/h6_upper_half_prereg_20260717.md`; public preregistration
  CI is pending, and no Lean proof-source edit may begin before it passes.
