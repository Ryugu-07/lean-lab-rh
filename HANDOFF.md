...
- Next: publish the implementation, verify public CI, backfill immutable evidence, then return to
  fresh `INDEPENDENT_AUDIT -> ROUTE_SELECTION` without reopening this fixed endpoint.
