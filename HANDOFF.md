...
- Next required gate: publish the immutable evidence backfill, wait for its independent public CI,
  then close the campaign. Do not reopen the old C-infinity endpoint.
