...
## RH current handoff (2026-07-15, M2/G3 candidate branch falsified)
...
- Exact TargetChecks and the transitive axiom audit pass locally with only `propext`,
  ...
  `git diff --check` also pass. Publication commit and public CI are the remaining gates for this
  audit batch.
