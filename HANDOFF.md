...
- Active preregistration is `CAMPAIGN-20260717-H6-GENERAL-STRIP-CONTRACTION-01` (`LITERATURE`).
  ...
  exposing the last de Bruijn step after a Polymath canopy certificate. No Lean proof source may
  be edited until the preregistration commit passes public CI.
