...
- The preregistered obstacle is neighborhood-uniform integrability of
  `u^k*exp(c*u^2+d*u)*Phi(u)` for arbitrary fixed real weights. H1-B/H2-B have lower immediate
  leverage; H10 remains the next census card rather than a rejected route; W2/G7 and M2/G3 have no
  materially new angle in this selection. No Lean proof source has yet been edited; public
  preregistration CI is pending.
