...
## RH current handoff (2026-07-15, R3 all-index compensated Li zero formula verified)
...
- Standalone/module checks, exact TargetChecks, standard-only axiom output, the 8,659-job full
  build, forbidden-token scans, and `git diff --check` pass locally. Public commit and CI evidence
  are pending backfill.
