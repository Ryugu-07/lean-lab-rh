...
- Record local obstruction `OBS-H6-ADJACENT-GAP-EIGHT-01`. This closes only the generic
  ...
  8,692-job build pass locally. Public implementation CI is pending; the global Goal remains
  active and returns to route selection after this campaign gate.
