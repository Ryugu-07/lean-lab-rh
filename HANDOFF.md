...
- W1c1 test-function integration and contour cutoff, W1c2 regularization/covariance extension,
  W2 positivity, and RH remain open. Next: publish the evidence backfill, verify its public CI,
  publish the final closure log, and return to fresh route selection.
