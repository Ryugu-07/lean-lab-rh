...
## RH current handoff (2026-07-16, R5 compact arithmetic implementation CI passed)
...
- Preregistration commit `ccebc64b1f3419636461e6fbf968fc55c4f24b8c` passed public CI run
  ...
  `87521708037`, in `1m51s`. Immutable evidence backfill and its own public CI remain before
  campaign closure.
