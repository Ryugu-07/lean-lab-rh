...
- Active preregistration is `CAMPAIGN-20260717-H6-GENERAL-STRIP-CONTRACTION-01` (`LITERATURE`).
  It targets arbitrary-base squared-strip contraction and the exact `t+y^2/2` all-real endpoint,
  exposing the last de Bruijn step after a Polymath canopy certificate. Preregistration commit
  `2685003e8f6617add0701a2b1680328ca8c4943f` passed public CI run `29571892273`, job
  `87857388857`, before proof edits. Both exact endpoints compile, and implementation commit
  `9ddee42657933ccd94533affa25f83a75392a1ea` passed public CI run `29572752471`, job
  `87860124993`; immutable evidence-backfill CI remains before campaign closure.
...
- 本地分类 `KNOWN_THEOREM_FORMALIZED`，`hard_gap_delta=0`，
  ...
  `87860124993`（`2m11s`）。下一门是不可变证据回填及其公开 CI；全局 RH Goal 始终
  active。
