...
## RH current handoff (2026-07-15, second M2/G3 candidate branch falsified)
...
- Exact TargetChecks and transitive axiom audit pass locally with only `propext`,
  ...
  `git diff --check` also pass. Publication commit and public CI remain for this audit batch.
