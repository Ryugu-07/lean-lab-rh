...
## RH current handoff (2026-07-15, sparse target branch eliminated locally)
...
- Standalone/module builds, exact TargetChecks, the 8619-job full build, forbidden scans, and
  ...
  `Classical.choice`, and `Quot.sound`. Commit/push/public CI remain.
- Preserve the previous sparse lower-frame theorem as useful auxiliary geometry, but do not revisit
  ...
  `ROUTE_SELECTION` and choose a different route family after publication.
