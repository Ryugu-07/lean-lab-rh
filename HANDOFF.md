...
- Fresh FALSIFICATION selection chooses `AUDIT-20260717-H6-REVERSE-HEAT-LI-01`. It fixes the
  ...
  H6 mechanism; it does not concern the actual theta-kernel zeros or falsify RH. No Lean proof
  source has yet been edited; public preregistration CI is pending.
