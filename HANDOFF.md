...
- The fixed aggregate theorem is `deBruijnNewmanHeat_thirdLi_covariance_endpoint`. Standalone
  ...
  Classification is `DISCOVERY_FORMALIZED_LOCAL`, `hard_gap_delta=0`, and
  `route_infrastructure_delta=1`. Implementation public CI and evidence closure remain; the RH
  Goal stays active.
