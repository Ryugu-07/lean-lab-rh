...
- Current campaign: `CAMPAIGN-20260717-H6-THRESHOLD-CLOSEDNESS-01` (`LITERATURE`) proves the exact
  ...
  CI run `29515723482`, job `87680126242`, in `1m56s`; proof implementation is now active.
...
- Local implementation now compiles the exact endpoint
  ...
  `29518062294`, build job `87687972172`, in `2m7s`. Immutable evidence backfill and its public CI
  remain.
