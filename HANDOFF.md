...
## RH current handoff (2026-07-11, M1-09)

- Active fixed gap: `G2/F1/Balazard-Saias`.
- New modules: `LeanLab/Riemann/ZetaConvexity.lean` and
  `LeanLab/Riemann/ZetaConvexityMidpoint.lean`.
...
- M1-09 proves the unconditional critical-line exponent `3/8`; this component of F1 is closed.
- Next exact task: audit and formalize the Balazard-Saias Mobius partial-sum estimate in the exact
  form consumed by Burnol's fixed-epsilon convergence argument.
