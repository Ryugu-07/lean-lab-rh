...
## RH current handoff (2026-07-15, R5 Weil convolution locally verified)
...
- Next: publish the evidence backfill, wait for its public CI, publish the final closure log, and
  verify clean synchronization. Then return to `INDEPENDENT_AUDIT -> ROUTE_SELECTION`.
