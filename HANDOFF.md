...
- Local classification is `ACTUAL_KERNEL_PF5_FORMALLY_FALSIFIED`, `hard_gap_delta=0`,
  `route_infrastructure_delta=1`, and `obstruction_map_delta=1`. Public implementation CI and
  evidence backfill remain; the global RH Goal stays active and returns to route selection only
  after this local campaign is publicly closed.
