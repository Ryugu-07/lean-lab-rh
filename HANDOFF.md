...
## RH current handoff (2026-07-16, R5 compact Weil zero cutoff implementation CI passed)
...
- Preregistration commit `e70201cb71b0909ae3f7b798336931e0bd9f32ee` passed public Lean Action CI
  ...
  `87514106839`, in `2m10s`. Publish immutable evidence backfill and require that commit's own
  public CI before campaign closure.
