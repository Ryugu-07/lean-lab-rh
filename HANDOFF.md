...
- Next required gate: commit and publish the implementation, wait for independent public CI, then
  backfill immutable evidence and close the campaign. Do not reopen the old C-infinity endpoint.
