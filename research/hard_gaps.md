...
| G8 | H6-E | open; exact H0-xi bridge, heat evolution, classical half-time good witness, and simple-zero force/path spine locally complete; collision exclusion and the time-zero all-real-zero endpoint remain unproved |
