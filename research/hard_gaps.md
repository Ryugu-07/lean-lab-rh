...
| G8 | H6-E | open; exact H0-xi bridge, heat evolution, half-time good witness, locally unique ordered real simple-zero paths, and the pair-removed law `(gap^2)'=8+4*gap*Re(remainder)` compile locally; global continuation, theta-specific integrated remainder control, collision exclusion, and the time-zero endpoint remain unproved |
