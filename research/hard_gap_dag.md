...
| OBS-H6-POSITIVE-COSH-LI3-01 | H6-X/H6-E | complete local obstruction; public CI pending | A normalized positive two-atom `cosh` transform is entire, reflection symmetric, and has positive real first and second standard Li values, but its third Li value is strictly negative. Positive-kernel and ordinary moment/Hankel positivity therefore cannot generically scale H6-Z to all indices; quantitative theta-kernel structure remains necessary. |
