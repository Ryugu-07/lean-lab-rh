...
| H6-H | open | Formalize the all-real-zero predicate, de Bruijn forward preservation, threshold existence, and threshold closedness for the exact H6-B/H6-H1 family. | The exact time-zero all-real-zero predicate, bijective zero coordinate, strict strip, and RH equivalence are publicly compiled. Forward preservation, threshold existence/closedness, and the global heat-flow zero theory remain open. |
