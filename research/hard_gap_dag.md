...
| H6-H | open globally; H2a-H2d and zero-force spine public | Formalize the all-real-zero predicate, de Bruijn forward preservation, threshold existence, threshold closedness, and the simple-zero dynamics interface for the exact H6-B/H6-H1 family. | The public framework reaches the unconditional `t=1/2` good witness. The public zero-dynamics spine proves an absolutely summable divisor force, the simple-zero derivative ratio, and differentiable path velocity. H6-E/G8 and collision exclusion stay open. |
